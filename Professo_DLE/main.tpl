			...
			<div class="col-md-8 mid_col">
				...
				<div class="mid_item_sec">
					...
					<ul class="services_item">
						<li id="dentistry_item"><a href="#">Стоматология</a></li>
						<li id="ortoped_item"><a href="#">Лечение позвоночника и суставов</a></li>
						<li id="kosmetik_item"><a href="#">Косметология</a></li>
						<li id="figura_item"><a href="#">Коррекция фигуры</a></li>
						<li id="salon_item"><a href="#">Салон красоты</a></li>
					</ul>
				</div>
				<h3>Цены</h3>
				<span class="mid_gr_line"></span>
